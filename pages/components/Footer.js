  ...
  return (
    ...
    <div className="md:flex md:justify-between">
      <div className="mb-6 md:mb-0">
        ...
        <img src="/fatanilogo.png" className="mr-5 h-6 sm:h-9" alt="Flowbite Logo" />
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
      ...
      <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
        ...
        <a href="#" className="text-orange-500 hover:text-gray-900 dark:hover:text-white">
        ...
        <a href="#" className="text-black-500 hover:text-gray-900 dark:hover:text-white">
